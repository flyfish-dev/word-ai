...
Word AI ships a formal `word-ai` Agent Skill. The installer copies it into the locations that current agent clients scan automatically:
...
Word AI 内置正式 `word-ai` Agent Skill。默认安装会自动写入：
